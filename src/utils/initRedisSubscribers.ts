...
function addRedisSubscriber(subscriber_key: string, io: Server<DefaultEventsMap, DefaultEventsMap, DefaultEventsMap, any>) {
...
export default function initRedisSubscribers(io: Server<DefaultEventsMap, DefaultEventsMap, DefaultEventsMap, any>) {
